      ...
      [
        {
          ...
          maxPeople: 20,
          ownerId: user1.id,
          startDate: new Date("2022-04-25T12:06:19.425Z"),
        ...
        },
        {
          ...
          maxPeople: 20,
          ownerId: user1.id,
          startDate: new Date("2022-04-23T12:06:19.425Z"),
          endDate: new Date("2022-04-28T12:06:19.425Z"),
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          endDate: new Date("2022-05-10T12:06:19.425Z"),
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
